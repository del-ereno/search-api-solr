...
// Development-only modules: never exported to, or imported from, config/sync.
$settings['config_exclude_modules'] = ['devel', 'devel_generate'];

// Solr for non-DDEV environments
if ($solr_password = getenv('SOLR_PASSWORD')) {
  $config['search_api.server.my_searchapi_solr']['backend_config']['connector_config']['password'] = $solr_password;
}
